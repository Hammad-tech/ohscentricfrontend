...
export const linksData: LinkCategory[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Occupational Safety and Health Act 1984", url: "https://www.legislation.wa.gov.au/legislation/statutes.nsf/main_mrtitle_650_homepage.html", description: "Occupational safety and health framework" },
      { name: "Occupational Safety and Health Regulations 1996", url: "https://www.legislation.wa.gov.au/legislation/statutes.nsf/main_mrtitle_651_homepage.html", description: "OSH regulations" },
